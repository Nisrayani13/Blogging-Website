  ...
  return (
    <div className='min-h-screen flex flex-col bg-gray-100'>
      ...
      <div className='mx-7 my-14'>
        <div className='font-bold text-2xl sm:text-3xl mb-4 text-center'>Welcome to Blogosphere</div>
        <div className='text-xl sm:text-2xl text-center'>Share your thoughts, discover new ideas, and connect with writers from around the world.</div>
      </div>
