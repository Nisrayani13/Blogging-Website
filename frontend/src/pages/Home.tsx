    ...
    <div className='min-h-screen bg-gray-100 flex flex-col'>
      ...
      <div className='flex justify-center mt-12'>
        <div className='bg-white border rounded-lg shadow-md flex flex-col justify-center items-center px-6 py-5'>
            ...
            <button className='bg-black p-2 text-white font-semibold rounded-lg m-2'>Get started</button>
        </div>
      </div>
    </div>
  )
...
function Topbar(){
    ...
    <div className="bg-white px-4 flex items-center justify-between border-b mb-4 py-1">
        ...
        <div className="flex justify-between items-center gap-x-5 pr-5">
            <div className='border border-gray-400 rounded-lg py-2 px-2.5'>
            ...
            <div className='bg-black border rounded-lg py-2 px-2.5'>
